...
/**
 * Created by danielholliday on 3/12/18.
 *
...
public class Shelter {
    ...
    // _id and __v are deprecated values used with RESTapi
    //private String _id;
    ...
    */
    ...
    public Map<String, Object> toMap() {
        ...
        result.put("special_notes", special_notes);
    ...
    public String toString() {
        String info = String.format("Shelter Info: uniqueKey = %d, shelterName = %s, " +
                        ...
                        "address = %s, specialNotes = %s, phoneNumber = %s", unique_key,
                shelter_name, capacity, restrictions, longitude, latitude, address, special_notes,
                phone_number);
        return info;
    }
}
